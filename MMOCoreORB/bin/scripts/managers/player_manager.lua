...
veteranRewards = {
		...
		-- 10 Day Rewards
		{templateFile = "object/tangible/veteran_reward/resource.iff", milestone=10, oneTime=true, description="@veteran_new:resourcecrate"},
		{templateFile = "object/tangible/veteran_reward/frn_couch_falcon_corner_s01.iff", milestone=10, oneTime=false, description="@veteran_new:falconcouch"},
		{templateFile = "object/tangible/veteran_reward/frn_couch_falcon_section_s01.iff", milestone=10, oneTime=false, description="@veteran_new:falconchair"},
		{templateFile = "object/tangible/veteran_reward/frn_vet_tie_fighter_toy.iff", milestone=10, oneTime=false, description="@veteran_new:mini_tiefighter"},
		{templateFile = "object/tangible/veteran_reward/frn_vet_x_wing_toy.iff", milestone=10, oneTime=false, description="@veteran_new:mini_xwing"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_darth_vader_toy.iff", milestone=20, oneTime=false, description="@veteran_new:mini_darthvader"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_jabba_toy.iff", milestone=30, oneTime=false, description="@veteran_new:mini_jabba"},
		...
		--{templateFile = "object/tangible/veteran_reward/antidecay.iff", milestone=30, oneTime=true, description="@veteran_new:antidecay"},
		...
		{templateFile = "object/tangible/furniture/tatooine/frn_tato_vase_style_01.iff", milestone=40, oneTime=false, description="Gold Ornamental Vase (Style 1)"},
		{templateFile = "object/tangible/furniture/tatooine/frn_tato_vase_style_02.iff", milestone=40, oneTime=false, description="Gold Ornamental Vase (Style 2)"},
		...
		{templateFile = "object/tangible/furniture/decorative/diagnostic_screen.iff", milestone=50, oneTime=false, description="@frn_n:diagnostic_screen"},
		{templateFile = "object/tangible/furniture/all/frn_all_plant_potted_lg_s2.iff", milestone=50, oneTime=false, description="Large Potted Plant (Style 2)"},
		{templateFile = "object/tangible/furniture/all/frn_all_plant_potted_lg_s3.iff", milestone=50, oneTime=false, description="Large Potted Plant (Style 3)"},
		{templateFile = "object/tangible/furniture/all/frn_all_plant_potted_lg_s4.iff", milestone=50, oneTime=false, description="Large Potted Plant (Style 4)"},

		-- 60 Day Rewards
		{templateFile = "object/tangible/furniture/modern/bar_counter_s1.iff", milestone=60, oneTime=false, description="Bar Countertop"},
		{templateFile = "object/tangible/furniture/modern/bar_piece_curve_s1.iff", milestone=60, oneTime=false, description="Bar Countertop (Curved, Style 1)"},
		{templateFile = "object/tangible/furniture/modern/bar_piece_curve_s2.iff", milestone=60, oneTime=false, description="Bar Countertop (Curved, Style 2)"},
		{templateFile = "object/tangible/furniture/modern/bar_piece_straight_s1.iff", milestone=60, oneTime=false, description="Bar Countertop (Straight, Style 1)"},
		{templateFile = "object/tangible/furniture/modern/bar_piece_straight_s2.iff", milestone=60, oneTime=false, description="Bar Countertop (Straight, Style 2)"},

		-- 70 Day Rewards
		{templateFile = "object/tangible/furniture/all/frn_all_table_s01.iff", milestone=70, oneTime=false, description="Round Cantina Table (Style 1)"},
		{templateFile = "object/tangible/furniture/all/frn_all_table_s02.iff", milestone=70, oneTime=false, description="Round Cantina Table (Style 2)"},
		{templateFile = "object/tangible/furniture/all/frn_all_table_s03.iff", milestone=70, oneTime=false, description="Round Cantina Table (Style 3)"},
		...
		{templateFile = "object/tangible/furniture/tatooine/frn_tato_cafe_parasol.iff", milestone=70, oneTime=false, description="@frn_n:frn_tato_cafe_parasol"},

		-- 80 Day Rewards
		{templateFile = "object/tangible/furniture/modern/rug_oval_m_s02.iff", milestone=80, oneTime=false, description="Medium Oval Rug"},
		{templateFile = "object/tangible/furniture/modern/rug_oval_sml_s01.iff", milestone=80, oneTime=false, description="Small Oval Rug"},
		{templateFile = "object/tangible/furniture/modern/rug_rect_m_s01.iff", milestone=80, oneTime=false, description="Medium Rectangular Rug"},
		{templateFile = "object/tangible/furniture/modern/rug_rect_sml_s01.iff", milestone=80, oneTime=false, description="Small Rectangular Rug"},
		{templateFile = "object/tangible/furniture/modern/rug_rnd_m_s01.iff", milestone=80, oneTime=false, description="Medium Round Rug"},
		{templateFile = "object/tangible/furniture/modern/rug_rnd_sml_s01.iff", milestone=80, oneTime=false, description="Small Round Rug"},
		...
		{templateFile = "object/tangible/wearables/helmet/helmet_s06.iff", milestone=90, oneTime=true, description="Rebel Endor Helmet"},

		-- 100 Day Rewards
		{templateFile = "object/tangible/furniture/modern/rug_rect_lg_s01.iff", milestone=100, oneTime=false, description="Large Rectangular Rug (Style 1)"},
		{templateFile = "object/tangible/furniture/modern/rug_rect_lg_s02.iff", milestone=100, oneTime=false, description="Large Rectangular Rug (Style 2)"},
		{templateFile = "object/tangible/furniture/modern/rug_oval_lg_s01.iff", milestone=100, oneTime=false, description="Large Oval Rug"},
		{templateFile = "object/tangible/furniture/modern/rug_rnd_lg_s01.iff", milestone=100, oneTime=false, description="Large Round Rug"},
		...
		{templateFile = "object/tangible/wearables/armor/nightsister/armor_nightsister_bicep_r_s01.iff", milestone=100, oneTime=true, description="Nightsister Melee Armguard"},
